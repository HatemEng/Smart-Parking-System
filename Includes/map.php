...
<html>
	...
	<body >
		...
		<div style="background: url('drawing/park.png') no-repeat; width: 1000px;height: 600px;">
			...
			<?php if ($pathShow == 'yes') { echo ''; ?>
				<!-- for path -->
				<span style="opacity: <?php echo $path1 ?>" id="path1">Exit</span>
				<span style="opacity: <?php echo $path2 ?>" id="path2"></span>
				<span style="opacity: <?php echo $path3 ?>" id="path3">Enterance</span>
				...
				<!-- For arraw location -->
				<div id="pathTarget" style="position: absolute; left:<?php echo $left+8 ?>px; top: <?php echo $top ?>px; 
